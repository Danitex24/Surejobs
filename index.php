...
<?php
	...
	//include("auth.php");
		//session_start();
	$id=$_SESSION['id'];
$select=mysqli_query($connection, "SELECT * FROM jobseekers where username='$id'")or die (mysqli_error($connection));
...
<body>	<div>
	...
	<h2 style="text-align: center; color: green;">Welcome to Surejobs No.1 online job portal</h2>
		...
		<nav class="topnav">
			<ul>
				<li>
					...
					<a href="company_info.php">Company Registration</a> |
					<a href="logout.php">Logout</a>
					<a href="log_printout.php">Printout Details</a>
					<a href="appliedjob.php">Apply for Job</a>
					<a href="all_vacancies.php">View all vacancies</a>
					<a href="user_profile.php?id=<?php echo $rows['id'] ?>">View Profile</a>
				</li>
			</ul>
		</nav>
		...
		<a href="all_vacancies.php"><h2 align="center"><<<<< Click here to view all the available jobs >>>>></h2></a>	
	</section>
...
<ul>
	<li>
		...
		<a href="suport_msg.php">Our Suport center</a>
			...
			<a href="index.php"><h2>Back to Top</h2></a>
		</div>
